...
class TestProductModel(unittest.TestCase):
    ...
    def test_deserialize_a_product(self):
        ...
        with self.assertRaises(DataValidationError) as context:
            product.deserialize(invalid_data_missing_field)
        self.assertIn("Invalid product: missing name", str(context.exception))
        invalid_data_invalid_boolean = {
            "name": "Fedora",
            "description": "A red hat",
            "price": "12.50",
            "available": "yes",
        ...
        with self.assertRaises(DataValidationError) as context:
            product.deserialize(invalid_data_invalid_boolean)
        self.assertIn("Invalid type for boolean [available]", str(context.exception))
        invalid_data_invalid_category = {
            "name": "Fedora",
            "description": "A red hat",
            "price": "12.50",
            "available": True,
        ...
        with self.assertRaises(DataValidationError) as context:
            product.deserialize(invalid_data_invalid_category)
    ...
    def test_find_by_price(self):
        ...
        for product in found_products:
            self.assertEqual(product.price, Decimal("19.99"))
        found_products = Product.find_by_price(Decimal("49.99"))
